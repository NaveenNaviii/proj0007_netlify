...
import { Employee } from 'src/app/models/emolyee-model-crud';
...
export class CrudOperationComponent implements OnInit,AfterViewInit  {
...
educationOptions=[
  ...
  constructor(private fb:FormBuilder,private employeeService:EmployeeCrudService) {
